...
export class CreateDatabaseServerV2Component implements OnInit {
  ...
  dbServerId: any;
  mode?: string
  constructor(private navigate: NavigationServiceV2, private router: Router, private dbService: DatabaseServerService, private activatedRoute: ActivatedRoute, @Inject(TOASTR_TOKEN) private toastr: Toastr) {
    this.mode = '';
    this.dbServer = {};
  }
